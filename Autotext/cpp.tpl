a:Standard Pair Include:pai:
#include <utility>
using std::pair;
using std::make_pair;

a:Standard Tuple Include:tup:
#include <boost/tuple/tuple.hpp>
#include <boost/tuple/tuple_comparison.hpp>
using boost::tuple; 
using boost::make_tuple; 
a:Standard String Include:str:
#include <string>
using std::string;
a:Standard String Stream Include:sst:
#include <sstream>
using std::stringstream;
a:Standard Vector Include:vec:
#include <vector>
using std::vector;
a:Standard Set Include:set:
#include <set>
using std::set;
a:Standard Map Include:map:
#include <map>
using std::map;
a:Standard Shared Ptr Include:sha:
...
!= NULL
a::log:
m_job->Write("[$ClassName$::$MethodName$] $end$");
a::n0:
!= 0
...

a:://-:
// [$YEAR$/$MONTHNAME$/$DAY$ %USERNAME%] TODO: $end$
a::///:
//////////////////////////////////////////////////////////////////////////

a::/*-:
